...
static struct timeout *to_checkudata(lua_State *L, int index)
{
    return luaL_checkudata(L, index, TIMEOUT_METANAME);
}

static struct timeouts *tos_checkudata(lua_State *L, int index)
{
    return *(struct timeouts **) luaL_checkudata(L, index, TIMEOUTS_METANAME);
}

static void tos_bind(lua_State *L, int tos_index, int to_index)
{
...
static void tos_unbind(lua_State *L, int tos_index, int to_index)
{
    lua_getuservalue(L, tos_index);
    lua_pushlightuserdata(L, to_checkudata(L, to_index));
    lua_pushnil(L);
...
static int to__index(lua_State *L)
{
...
static int to__newindex(lua_State *L)
{
    if (LUA_TNIL == lua_getuservalue(L, 1)) {
        lua_newtable(L);
        lua_pushvalue(L, -1);
...
int luaopen_timeout(lua_State *L)
{
    to_newmetatable(L);
...
static int tos_update(lua_State *L)
{
...
static int tos_step(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
    lua_Number n = luaL_checknumber(L, 2);
...
static int tos_timeout(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
...
static int tos_add(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
...
static int tos_del(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
    struct timeout *to = to_checkudata(L, 2);
...
static int tos_get(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
    struct timeout *to;
...
static int tos_pending(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
...
static int tos_expired(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
...
static int tos_check(lua_State *L)
{
    struct timeouts *T = tos_checkudata(L, 1);
...
static int tos__next(lua_State *L)
{
...
static int tos_timeouts(lua_State *L)
{
...
static int tos__gc(lua_State *L)
{
...
static int tos_new(lua_State *L)
{
...
static void tos_newmetatable(lua_State *L)
{
...
int luaopen_timeouts(lua_State *L)
{
    to_newmetatable(L);
    tos_newmetatable(L);
